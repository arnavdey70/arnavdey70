...
expirydate = datetime.date(2022, 9, 3)
#expirydate = datetime.date(20212, 8, 30)
today=date.today()
def hero():
    ...
    while(y):
        ...
        if (len(numbers)>11):
            ...
            sys.exit(" \n \n \n Contact on Telegram @Darkhacker")
            #print(numbers)
...
if(expirydate>today):
    ...
    if (False):
        ...
        print(" admin on telegram @Darkhacker")
    ...
    print(" on telegram ----@Darkhacker for activating")
